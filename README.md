...
This page contains the audio capture to classify and reproduce sounds. Each sound must be registered with a label and 
...
capture your voice (allow microphone permission in google chrome needed). Then, just start talking for label classification.
